...
```{r DensIndivRespPlot_transFlat, anchor=FIGREF}
...
```{r DensIndivRespGrouped_transFlatPlot, ancho=FIGREF}
ggplot(drum_beats, aes(transFlat, 
                       color = subj, 
                       linetype = cond)) + 
  geom_density(alpha = 0.1) +
...
```{r DensIndivSeriesGrouped_transFlatPlot, anchor=FIGREF, fig.width=7}
ggplot(drum_beats, aes(transFlat, 
                       color = cond, 
                       group = series)) + 
  geom_density(alpha = 0.1) +
...
```{r DensIndivRespPlot_transCrest, anchor=FIGREF}
...
```{r DensIndivRespGrouped_transCrestPlot, ancho=FIGREF}
ggplot(drum_beats, aes(transCrest, 
                       color = subj, 
                       linetype = cond)) + 
  geom_density(alpha = 0.1) +
...
```{r DensIndivSeriesGrouped_transCrestPlot, anchor=FIGREF, fig.width=7}
ggplot(drum_beats, aes(transCrest, 
                       color = cond, 
                       group = series)) + 
  geom_density(alpha = 0.1) +
...
```{r m7_condPlot, anchor=FIGREF, fig.width=7, fig.height=8}
...
```{r m10_condPlot, anchor=FIGREF, fig.width=12, fig.height=8}
...
```{r m11_condPlot, anchor=FIGREF, fig.width=12, fig.height=8}
