...
Based on the above we can infer that instructions cause differences in the mean, the skewness, and spread of transSC (`r figr("m7_condPlot")`A, D, and G), while playing with the dominant vs non-dominant arm only seems to invoke small differences in skewness and spread, but not so in the mean (`r figr("m7_condPlot")`E and H).
